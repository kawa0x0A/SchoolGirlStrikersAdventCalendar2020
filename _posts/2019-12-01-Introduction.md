...
この記事は[『スクールガールストライカーズ2 Advent Calendar 2020』](https://adventar.org/calendars/5395) の12/1分の記事です。
...
# 自己紹介
 ...
 スクストのログイン日数は今日の時点で2235日なので、スクスト歴は約6年ほどになります。
...
![現在のステータス]({{ site.baseurl }}/assets/images/posts/20191201_Status.PNG)
...
# アドベントカレンダーについて
 ...
 ~~Webサイトの環境構築に手間取ったので、去年の記事をコピペした説明です。すいません。~~

 以上乱文ですが、今日の記事はここまでにしたいと思います。今年もいっぱいネタを考えないとな～。
 ~~初日からこんなに焦っていて無事に完走できるのか?~~
